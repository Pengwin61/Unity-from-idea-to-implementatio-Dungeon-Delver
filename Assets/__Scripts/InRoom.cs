...
public class InRoom : MonoBehaviour
{
    ...
    public bool keepInRoom = true;      // ≈сли флажок keepInRoom установлен, тогда в каждом кадре следующие строки
                                        // будут удерживать координаты roomPos этого игрового объекта в пределах
                                        // стен, ограничивающих комнату
    public float gridMult = 1;

    private void LateUpdate()
    {
        if (keepInRoom) // ƒл€ удержани€ врагов в комнате
        {
    ...
    // ¬ычисл€ет координаты узла сетки, ближнего к данному персонажу
